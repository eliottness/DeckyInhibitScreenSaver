...
**桌面模式兼容性：** 本插件使用 D-Bus 信号监控来检测 KDE 服务何时启动，并在冲突发生之前主动释放自己的 D-Bus 服务。当 KDE Plasma 启动时，插件会收到 NameOwnerChanged 信号并立即注销其服务，允许 KDE 注册其原生电源管理服务而不会发生冲突。当返回游戏模式时，服务会自动重新注册。
